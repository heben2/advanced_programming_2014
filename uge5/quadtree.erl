                ...
                BoundTmp -> %This also includes universe
                    try
                        DataNew = lists:map(fun(E) -> 
                                            ...
                                            Data),
                        lists:map(fun(E)-> send_add(Parent, E) end, DataNew), %Send elements to parent for re-adding
                        qtreeLeaf(Bound, Limit, Parent, [])
