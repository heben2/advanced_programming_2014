...
-- Helper function working like chail1, though expanded to take another parser type to apply on right side after left recursion.
...
com = c0
    where c0 = c1 `chainl1` op (symbol "||") Par
          ...
          c2 = c3 <|> c4 -- Might need try-statement for c3; "{"
          c3 = parens "{" com "}"
